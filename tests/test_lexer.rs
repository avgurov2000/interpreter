...
mod test {
    ...
    fn create_token_full(
        token_type: TokenType, ch: Option<String>, row_position: usize, characher_position: usize,
    ) -> Token {
    ...
    fn test_lexer_premitives_with_positions() -> TestResult<()>{
        ...
        let expected_tokens = vec![
            ...
            create_token_full(TokenType::Punctuation(PunctuationType::Semicolon), None, 0, 7),
        ...
        for expected_token in expected_tokens {
            ...
            assert_eq!(token.get_character_position(), expected_token.get_character_position());
        }
    ...
    fn test_lexer_key_words() -> TestResult<()>{
        ...
        let expected_tokens = vec![
            create_token_short(TokenType::SpecialWord(SpecialWordType::Let), Some("let".to_string())),
            ...
            create_token_short(TokenType::Punctuation(PunctuationType::Assign), None),
            create_token_short(TokenType::SpecialWord(SpecialWordType::Function), Some("fn".to_string())),
            create_token_short(TokenType::Punctuation(PunctuationType::LParen), None),
...
";
        ...
        let expected_tokens = vec![
            create_token_full(TokenType::SpecialWord(SpecialWordType::Let), Some("let".to_string()), 0, 0),
            ...
            create_token_full(TokenType::Punctuation(PunctuationType::Semicolon), None, 0, 10),

            create_token_full(TokenType::SpecialWord(SpecialWordType::Let), Some("let".to_string()), 1, 0),
            ...
            create_token_full(TokenType::Punctuation(PunctuationType::Semicolon), None, 1, 10),

            create_token_full(TokenType::SpecialWord(SpecialWordType::Let), Some("let".to_string()), 2, 0),
            ...
            create_token_full(TokenType::SpecialWord(SpecialWordType::Function), Some("fn".to_string()), 2, 17),
            ...
            create_token_full(TokenType::ControlFlow(ControlFlowType::If), Some("if".to_string()), 3, 4),
            ...
            create_token_full(TokenType::SpecialWord(SpecialWordType::Return), Some("return".to_string()), 4, 8),
            create_token_full(TokenType::SpecialWord(SpecialWordType::True), Some("True".to_string()), 4, 15),
            create_token_full(TokenType::Punctuation(PunctuationType::Semicolon), None, 4, 19),

            create_token_full(TokenType::Punctuation(PunctuationType::RBrace), None, 5, 4),
            create_token_full(TokenType::ControlFlow(ControlFlowType::Else), Some("else".to_string()), 5, 6),
            create_token_full(TokenType::Punctuation(PunctuationType::LBrace), None, 5, 11),

            create_token_full(TokenType::SpecialWord(SpecialWordType::Return), Some("return".to_string()), 6, 8),
            create_token_full(TokenType::SpecialWord(SpecialWordType::False), Some("False".to_string()), 6, 15),
            create_token_full(TokenType::Punctuation(PunctuationType::Semicolon), None, 6, 20),
            ...
            create_token_full(TokenType::Punctuation(PunctuationType::NotEqual), None, 9, 2),
